...
#SBATCH -J fb_fg_minus_stack              # Job name
...
cd $PROJECT_PATH
singularity exec --nv $SING_PATH python mbrl/main_offline.py experiments/cee_us/settings/common/fb/fg_filt/minus_stack.yaml
# Compute Phase 
