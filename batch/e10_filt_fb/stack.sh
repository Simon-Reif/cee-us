...
#SBATCH -J fb_e10_stack_filt               # Job name
...
cd $PROJECT_PATH
singularity exec --nv $SING_PATH python mbrl/main_offline.py experiments/cee_us/settings/common/fb/e10_filt/stack.yaml
# Compute Phase 
