...
#SBATCH -J planner_flip_data_collection               # Job name
...
cd $PROJECT_PATH
singularity exec --nv $SING_PATH python mbrl/main.py experiments/cee_us/settings/construction/zero_shot_generalization/fixed_goal_positions/flip.yaml
# Compute Phase
