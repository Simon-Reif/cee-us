...
if __name__ == "__main__":
    ...
    wandb.agent(sweep_id="srtea/cee-us/eejh51fm", count=1) # sweep13: discount and pesspen

    #wandb.agent(sweep_id="srtea/cee-us/km1ybol9", count=1) # sweep11: fp ablation zdim50
