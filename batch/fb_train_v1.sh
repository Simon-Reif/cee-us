...
cd $PROJECT_PATH
singularity exec --nv $SING_PATH python mbrl/main_offline.py experiments/cee_us/settings/common/fb/specifics/dicount_norm_obs.yaml
# Compute Phase 
